...
import { EntityStateFilterProps } from "../utils/types";

const filterOptions = [
  { value: "all", label: "All Entity States" },
  { value: "on", label: "On" },
  { value: "off", label: "Off" },
  { value: "unavailable", label: "Unavailable" },
];

export function EntityStateFilter({ value, onChange }: EntityStateFilterProps) {
    ...
    <div className="lg:w-64">
      ...
      <Select.Root value={value} onValueChange={onChange}>
        <Select.Trigger
          ...
          title="Filter automations by entity state"
        >
